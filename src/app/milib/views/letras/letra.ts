 ...
 */
export class Letra extends View {

    private sColor:string=null;
    private lblTexto:Label=null;
    private listener:LetraListener;
     ...
     */
    public setListener(listener:LetraListener):void{
